                                 ...
                                 VertexPositionVelocity3D>
{
  public:
    TargetOdometry3DEdge(double dt, double noiseSigma)
    {
        ...
        // noise model; we add a small stabilising term on the diagonal to make
        // it invertible
                                 ...
                                 g2o::OptimizableGraph::Vertex *to)
    {
        ...
        VertexPositionVelocity3D *vj =
            static_cast<VertexPositionVelocity3D *>(to);
    ...
    virtual double
    initialEstimatePossible(const g2o::OptimizableGraph::VertexSet &from,
                            g2o::OptimizableGraph::Vertex *to)
    {
    ...
    void computeError()
    {
        ...
        for (int k = 3; k < 6; k++) {
            _error[k] = vi->estimate()[k] + _dt * _measurement[k - 3] -
                        vj->estimate()[k];
        }
    }
